...
from multi_page_google_parser_improved import parse_google_text

def test_all_google_invoices_improved():
    """Test all 57 Google invoices with improved multi-page parser"""
    ...
    report_data = {
        "report_metadata": {
            ...
            "parser_version": "multi_page_google_parser_improved_with_all_pages_and_fees"
        },
        "summary": {
            "successful_files": 0,
            "error_files": 0,
    ...
    for i, filename in enumerate(google_files, 1):
        ...
        try:
            ...
            # Parse using the improved multi-page Google parser
            ...
            if records:
                ...
                file_result = {
                    ...
                    "parser_used": "improved_multi_page_with_fees"
                }
                ...
                if records:
                    ...
                    item_type = first_record.get('item_type', 'None')
                    print(f"     Type: {item_type}, Project ID: {project_id}, Campaign ID: {campaign_id}")
    ...
    print(f"\n" + "="*80)
    print("IMPROVED GOOGLE INVOICE PROCESSING REPORT")
    print("="*80)
...
if __name__ == "__main__":
    test_all_google_invoices_improved()