...
Fixed to exclude invoice 246952155 which should not be included in totals
"""
...
if __name__ == "__main__":
    print("Facebook Parser Fixed - Excludes invoice 246952155")